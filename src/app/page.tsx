    ...
    <div className="flex flex-col min-h-screen bg-background">
      <header className="px-4 lg:px-6 h-16 flex items-center bg-card/80 backdrop-blur-md sticky top-0 z-50 border-b">
        <Link href="/" className="flex items-center justify-center gap-2">
          <Image
            src={logoUrl}
            alt="Cámara de Comercio de Toledo"
            width={160}
            height={50}
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_500px] xl:grid-cols-[1fr_600px] items-center">
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  <h1 className="text-4xl font-bold font-headline tracking-tighter sm:text-6xl xl:text-7xl/none">
                    Domina la <span className="text-primary">Inteligencia Artificial</span> para tu negocio
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground text-lg md:text-xl leading-relaxed">
                    Plataforma educativa interactiva del curso de IA de la Cámara de Comercio de Toledo (120 horas). Aprende a aplicar la IA en tu empresa con herramientas prácticas y proyectos reales.
                  </p>
                </div>
              ...
              <div className="relative group">
                ...
                <Image
                  ...
                  width={600}
                  height={400}
                  alt="Curso IA Cámara de Comercio de Toledo"
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              <div className="space-y-2">
                ...
                <p className="max-w-[800px] text-muted-foreground text-lg">
                  Una experiencia de aprendizaje práctica de 120 horas donde la teoría se encuentra con la aplicación real mediante herramientas de IA.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-6xl items-start gap-8 lg:grid-cols-3">
              <Card className="relative overflow-hidden border-none shadow-md bg-card transition-all hover:shadow-xl hover:-translate-y-1">
                ...
                <CardContent className="text-center text-muted-foreground p-6 pt-2">
                  9 módulos estructurados que evolucionan contigo, desde los fundamentos de la IA hasta el desarrollo de proyectos reales para tu negocio.
                </CardContent>
              </Card>
              <Card className="relative overflow-hidden border-none shadow-md bg-card transition-all hover:shadow-xl hover:-translate-y-1">
                <CardHeader className="flex flex-col items-center text-center pb-2 pt-8">
                ...
                <CardContent className="text-center text-muted-foreground p-6 pt-2">
                  Resuelve tus dudas al instante con Cato, genera resúmenes automáticos y crea contenido visual con nuestras herramientas integradas.
                </CardContent>
              </Card>
               <Card className="relative overflow-hidden border-none shadow-md bg-card transition-all hover:shadow-xl hover:-translate-y-1">
                <CardHeader className="flex flex-col items-center text-center pb-2 pt-8">
                ...
                <CardContent className="text-center text-muted-foreground p-6 pt-2">
                  No solo aprendes, construyes. El curso culmina con proyectos prácticos aplicados a casos reales del mundo empresarial.
                </CardContent>
              </Card>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-primary px-8 py-16 text-primary-foreground shadow-2xl">
              ...
              <div className="relative flex flex-col items-center justify-center gap-6 text-center">
                ...
                <p className="max-w-[700px] text-primary-foreground/80 text-lg md:text-xl">
                  Únete a la comunidad de profesionales y empresarios de Toledo y empieza a transformar tu negocio con IA.
                </p>
                <div className="mt-4">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-4">
              <span className="font-bold font-headline">Curso IA - Cámara de Comercio de Toledo</span>
            </div>
            <p className="text-sm text-muted-foreground order-last md:order-none">
              &copy; 2026 Curso de IA - Cámara de Comercio de Toledo. Creado por Diego Gómez Marín
            </p>
