        ...
        <div className="mx-auto grid w-[350px] gap-6">
          <div className="grid gap-2 text-center">
            ...
            <p className="text-balance text-muted-foreground">
              Accede a tu cuenta del curso de IA
            </p>
          </div>
          ...
          <div className="mt-auto">
            <blockquote className="space-y-2 bg-black/40 p-6 rounded-xl backdrop-blur-sm">
              <p className="text-lg italic">
                &ldquo;Esta plataforma ha transformado mi manera de aprender sobre IA. Las herramientas interactivas y el apoyo de la Cámara de Comercio de Toledo son simplemente increíbles.&rdquo;
              </p>
