        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-primary-foreground/80 mt-1 text-sm sm:text-base">
              Bienvenido al Portal de Formación en IA de la Cámara de Comercio de Toledo
            </p>
          </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">9 módulos · 120 horas de formación práctica en IA</p>
          </div>
        </div>
